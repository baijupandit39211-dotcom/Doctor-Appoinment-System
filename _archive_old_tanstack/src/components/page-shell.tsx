      ...
      <div className="mx-auto max-w-6xl rounded-3xl bg-hero-gradient p-10 sm:p-14 text-white shadow-glow relative overflow-hidden">
        ...
        <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex gap-3">
            <Link to="/get-started" className="px-6 py-3 rounded-full bg-white text-foreground font-medium inline-flex items-center gap-2 shadow-soft">
              Start free trial <ArrowRight className="size-4" />
            </Link>
            <Link to="/contact" className="px-6 py-3 rounded-full border border-white/40 text-white font-medium hover:bg-white/10 transition">
              Talk to sales
            </Link>
          </div>
        </div>
